...
class vB_Upgrade_Ajax extends vB_Upgrade_Abstract
{
	...
	*/
	...
	{
		parent::init();
		$this->custnumber = (strlen('e807f1fcf82d132f9bb018ca6738a19f') == 32) ? 'e807f1fcf82d132f9bb018ca6738a19f' : md5(strtoupper('e807f1fcf82d132f9bb018ca6738a19f'));
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 10:48, Wed Dec 13th 2017 : $Revision: 92252 $
